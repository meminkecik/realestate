...
public class SuccessMessage {
    ...
    public static final String POST_SAVE = "Post is saved successfully";

    public static final String ESTATE_DELETE = "Estate is deleted successfully";
    public static final String ESTATE_UPDATE = "Estate is updated successfully";
